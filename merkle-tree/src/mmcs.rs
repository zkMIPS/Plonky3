...
use p3_matrix::{Dimensions, MatrixRowSlices};
    ...
    [PW::Value; DIGEST_ELEMS]: Serialize + for<'de> Deserialize<'de>,
{
    ...
    fn commit<M: MatrixRowSlices<P::Scalar>>(
        &self,
        inputs: Vec<M>,
    ...
    fn open_batch<M: MatrixRowSlices<P::Scalar>>(
        &self,
        index: usize,
        ...
        let openings = prover_data
            ...
            .map(|matrix| {
                ...
                matrix.row(reduced_index).into_iter().copied().collect()
            })
            .collect_vec();
    ...
    fn get_matrices<'a, M: MatrixRowSlices<P::Scalar>>(
        &self,
