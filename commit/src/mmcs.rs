...
pub trait Mmcs<T>: Clone {
    ...
    fn commit<M: MatrixRowSlices<T>>(
        &self,
        inputs: Vec<M>,
    ) -> (Self::Commitment, Self::ProverData<M>);

    fn commit_matrix<M: MatrixRowSlices<T>>(
        &self,
        input: M,
    ) -> (Self::Commitment, Self::ProverData<M>) {
    ...
    fn open_batch<M: MatrixRowSlices<T>>(
        &self,
        index: usize,
    ...
    fn get_matrices<'a, M: MatrixRowSlices<T>>(
        &self,
        prover_data: &'a Self::ProverData<M>,
    ) -> Vec<&'a M>;

    fn get_matrix_heights<M: MatrixRowSlices<T>>(
        &self,
        prover_data: &Self::ProverData<M>,
    ) -> Vec<usize> {
    ...
    fn get_max_height<M: MatrixRowSlices<T>>(&self, prover_data: &Self::ProverData<M>) -> usize {
